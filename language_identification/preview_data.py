...
if __name__ == "__main__":
    ...
    for model in [ "eurollm", "gams" ]:
        ...
        print("-"*30)
        dfs[model] = load_multilang_json(f"./{model}9b_language_id_with_scores")
    ...
    df_join.to_json("paired_data_with_scores.jsonl", orient="records", lines=True, force_ascii=False)
