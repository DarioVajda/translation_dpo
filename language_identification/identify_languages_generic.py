...
def load_dataset(input_data_dir):
    ...
    # df = pd.read_json(input_data_dir, lines=True)
...
def main(client=None, args=None, data_to_check=None, id=0):
    ...
    print("-"*60)
    print("Performing language identification on the data at path:", args.input_path)
    print("-"*60)
    
    # Params
    # multilingual_data_path = f'/ceph/hpc/data/s24o01-42-users/corpuses/wikipedia/wikipedia_{data_to_check}_translation.jsonl'
    # multilingual_data_path = f'/ceph/hpc/data/s24o01-42-users/translation_optimization/comet_score/scored_data/ccnews_{data_to_check}{f'{id}' if id>0 else ''}.jsonl'
    multilingual_data_path = args.input_path
    # language_separated_output_path = f'./{data_to_check}_language_id_with_scores{f'_{id}' if id>0 else ''}' # args.output_path
    language_separated_output_path = args.output_path
    ...
    model_path = '/ceph/hpc/data/s24o01-42-users/translation_optimization/language_identification/fasttext_model/lid.176.bin' # args.model_path
    language_field = "language"

    print("Input data path:", multilingual_data_path)
    print("Output data path:", language_separated_output_path)
...
if __name__ == "__main__":
    ...
    main(client=client, args=args)
    print("Finished language identification")
