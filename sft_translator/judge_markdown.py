...
def load_data():
    in_data_path = "/shared/workspace/povejmo/translation_optimization/get_translations/nemotron_translations"
    data = []
...
def correct_examples(model_path, input_path, output_path, gpu_memory_util, tp_size, id, text_field):
    ...
    # Save the data
    output_path = output_path + f"/data_{text_field}.jsonl"
...
if __name__=="__main__":
    args=parse_args()
    correct_examples(args.model_path, None, args.output_path, args.gpu_memory_util, args.tp_size, 0, args.text_field)
